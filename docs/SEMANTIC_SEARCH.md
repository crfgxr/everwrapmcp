# Meaning-based search through EverWrap
...
Example: ask EverWrap to find past notes about feeling stuck in a role that does
...
- The block list controls export through EverWrap. Evernote may already index
