...
EverWrapMCP previously rejected note bodies above 100,000 characters, including
...
After updating an installation, restart its EverWrapMCP connection/client so
